...
$moduleName = 'PSGridCoin'
$homedirectory = Join-Path -Path $env:GITHUB_WORKSPACE -ChildPath "PSGridCoin"
...
$manifestParameters = @{
     ...
     Description = "A module to interacting with GridCoin via RPC Commands"
}
...
Publish-Module -Path $homedirectory -NuGetApiKey $env:PWSHGALLERY -Tags "GridCoin"
